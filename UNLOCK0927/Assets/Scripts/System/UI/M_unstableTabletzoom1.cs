...
public class M_unstableTabletzoom1 : MonoBehaviour
{
    public bool Tableton = false; // 타블렛이 확대되었습니다.
    public GameObject tablet_Unstable_UI;
    ...
    public void tabletzoomin() // 타블렛을 눌렀음
    {
        if (Tableton == false)
        {
            ...
            //2080 / 1170
            Tableton = true;
            tablet_Unstable_UI.SetActive(true); // UI 액티브
